"use strict";
(self["webpackChunkportfolio"] = self["webpackChunkportfolio"] || []).push([["node_modules_splinetool_runtime_build_opentype_js"],{
...
g.OPERAND = function (e, r) {
  var t = [];
  if (Array.isArray(r)) for (var a = 0; a < r.length; a += 1) U.argument(e.length === r.length, "Not enough arguments given for type" + r), t = t.concat(g.OPERAND(e[a], r[a]));else if (r === "SID") t = t.concat(g.NUMBER(e));else if (r === "offset") t = t.concat(g.NUMBER32(e));else if (r === "number") t = t.concat(g.NUMBER(e));else if (r === "real") t = t.concat(g.REAL(e));else throw new Error("Unknown operand type " + r);
  return t;
};
...
function tn(e, r, t, a) {
  ...
  var u = [".notdef"],
      o = i.parseCard8();
  if (o === 0) for (var l = 0; l < t; l += 1) n = i.parseSID(), u.push(Oe(a, n));else if (o === 1) for (; u.length <= t;) {
...
function an(e, r, t) {
  var a,
      ...
      s = new k.Parser(e, r),
      i = s.parseCard8();
  if (i === 0) for (var u = s.parseCard8(), o = 0; o < u; o += 1) a = s.parseCard8(), n[a] = o;else if (i === 1) {
    var l = s.parseCard8();
    a = 1;
...
function ra(e) {
  ...
  for (var t = Kn(e), a = 0; a < t.length; ++a) {
    ...
    for (var l = 0; l < n.length; ++l) if (s = i, i = u, u = n[(l + 1) % n.length], i.onCurve) r.lineTo(i.x, i.y);else {
      var f = s,
          h = u;
      s.onCurve || (f = {
        x: (i.x + s.x) * .5,
...
ia.prototype.exec = function (e, r) {
  ...
  if (!(this._errorState > 2)) {
    ...
    if (!a || a.ppem !== r) {
      ...
      var s = t.tables.cvt;
      if (s) for (var i = a.cvt = new Array(s.length), u = r / t.unitsPerEm, o = 0; o < s.length; o++) i[o] = s[o] * u;else a.cvt = [];
...
function la(e, r) {
  ...
  do if (s = t[++a], s === 88) n++;else if (s === 89) n--;else if (s === 64) a += t[a + 1] + 1;else if (s === 65) a += 2 * t[a + 1] + 1;else if (s >= 176 && s <= 183) a += s - 176 + 1;else if (s >= 184 && s <= 191) a += (s - 184 + 1) * 2;else if (r && n === 1 && s === 27) break; while (n > 0);
...
//# sourceMappingURL=node_modules_splinetool_runtime_build_opentype_js.js.map